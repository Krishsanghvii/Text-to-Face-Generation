...
prompt = ctk.CTkEntry(height=40, width=512, text_font=("Arial", 20), text_color="black", fg_color="white", placeholder_text="Enter your prompt!") 
...
#one more generate function
#generate2() collab code
#one more trigger function
#downloaded image to showing
#image size configure
